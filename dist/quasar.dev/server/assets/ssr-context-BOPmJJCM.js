import{resolveComponent as j,mergeProps as E,withCtx as c,createTextVNode as s,unref as d,createVNode as n,useSSRContext as P}from"vue";import{ssrRenderComponent as l}from"vue/server-renderer";import{c as g}from"./page-utils-C-QWsEHe.js";import{D as T,a as i}from"./DocPage-DKr-0pQn.js";import{D as h}from"./DocPrerender-DPOnWPFO.js";import{C as u}from"./CopyButton-l3ndfN49.js";import{_ as O}from"../server-entry.js";import"quasar";import"@quasar/extras/mdi-v6";import"vue-router";import"@quasar/extras/fontawesome-v5";import"@quasar/extras/fontawesome-v6";import"@quasar/extras/mdi-v7";import"quasar/icon-set/svg-mdi-v6.mjs";const b={__name:"ssr-context",__ssrInlineRender:!0,setup(C){const x=[{id:"usage",title:"2. Usage"},{id:"anatomy-of-ssrcontext",title:"3. Anatomy of ssrContext"}];return(w,R,S,q)=>{const f=j("q-tab-panel");R(l(T,E({title:"The ssrContext Object",desc:"(@quasar/app-vite) The ssrContext Object in Quasar SSR",overline:"Quasar CLI with Vite - @quasar/app-vite",heading:"","edit-link":"quasar-cli-vite/developing-ssr/ssr-context",toc:x},q),{default:c((A,p,m,e)=>{if(p)p(`<p${e}>The <code class="doc-token"${e}>ssrContext</code> Object is the SSR context with which all the app’s Vue components are rendered with.</p><h2 id="usage" class="doc-heading doc-h2"${e}>Usage</h2><div class="doc-note doc-note--warning"${e}><p class="doc-note__title"${e}>WARNING</p><p${e}>The <code class="doc-token"${e}>ssrContext</code> Object is available only on SSR builds, on the server-side compilation (when <code class="doc-token"${e}>process∙env∙SERVER === true</code>).</p></div><p${e}>Among other places, it is supplied as parameter to `),p(l(i,{to:"/quasar-cli-vite/boot-files"},{default:c((k,o,r,t)=>{if(o)o("boot files");else return[s("boot files")]}),_:1},m,e)),p(", to the "),p(l(i,{to:"/quasar-cli-vite/state-management-pinia-vuex"},{default:c((k,o,r,t)=>{if(o)o("Vuex store");else return[s("Vuex store")]}),_:1},m,e)),p(" and "),p(l(i,{to:"/quasar-cli-vite/routing"},{default:c((k,o,r,t)=>{if(o)o("Vue Router");else return[s("Vue Router")]}),_:1},m,e)),p(" initialization functions, and to the "),p(l(i,{to:"/quasar-cli-vite/prefetch-feature"},{default:c((k,o,r,t)=>{if(o)o("preFetch");else return[s("preFetch")]}),_:1},m,e)),p(" method:</p>"),p(l(d(h),null,{default:c((k,o,r,t)=>{if(o)o(`<pre class="doc-code"${t}><code${t}><span class="token comment"${t}>// a boot file</span>
