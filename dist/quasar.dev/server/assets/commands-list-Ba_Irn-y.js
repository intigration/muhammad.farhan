...
$ quasar build `),a("span",{class:"token parameter variable"},"-d"),n(),a("span",{class:"token punctuation"},"["),n("-m "),a("span",{class:"token operator"},"<"),n("mode"),a("span",{class:"token operator"},">"),a("span",{class:"token punctuation"},"]")])]),a(o,{lang:"bash"})]}),_:1},d,e)),i(`<h2 id="clean" class="doc-heading doc-h2"${e}>Clean</h2><p${e}>Cleans up all the build assets:</p>`),i(p(c(k),null,{default:r((m,t,u,s)=>{if(t)t(`<pre class="doc-code"${s}><code${s}>$ quasar clean</code></pre>`),t(p(o,{lang:"bash"},null,u,s));else return[a("pre",{class:"doc-code"},[a("code",null,"$ quasar clean")]),a(o,{lang:"bash"})]}),_:1},d,e)),i(`<h2 id="new" class="doc-heading doc-h2"${e}>New</h2><p${e}>Generates Components, Pages, Layouts, Vuex Store.</p><div class="doc-note doc-note--tip"${e}><p class="doc-note__title"${e}>TIP</p><p${e}>This command is simply a helper in order to quickly scaffold a page/layout/component/vuex store module. You are not required to use it, but can help you when you don’t know how to start.</p></div>`),i(p(c(k),null,{default:r((m,t,u,s)=>{if(t)t(`<pre class="doc-code"${s}><code${s}>$ quasar new <span class="token parameter variable"${s}>-h</span>
 ...
 Methods
   ...
   *No methods*`)])]),a(o,{lang:"bash"})]}),_:1},d,e)),i(`<h2 id="inspect" class="doc-heading doc-h2"${e}>Inspect</h2><p${e}>This command can be used to inspect the Webpack config generated by Quasar CLI.</p>`),i(p(c(k),null,{default:r((m,t,u,s)=>{if(t)t(`<pre class="doc-code"${s}><code${s}>$ quasar inspect <span class="token parameter variable"${s}>-h</span>
  ...
  Usage
    ...
    $ quasar inspect <span class="token parameter variable"${s}>-m</span> electron <span class="token parameter variable"${s}>-p</span> <span class="token string"${s}>&#39;module.rules&#39;</span>
  ...
  Options
    ...
    --mode, <span class="token parameter variable"${s}>-m</span>       App mode <span class="token punctuation"${s}>[</span>spa<span class="token operator"${s}>|</span>ssr<span class="token operator"${s}>|</span>pwa<span class="token operator"${s}>|</span>bex<span class="token operator"${s}>|</span>cordova<span class="token operator"${s}>|</span>electron<span class="token punctuation"${s}>]</span> <span class="token punctuation"${s}>(</span>default: spa<span class="token punctuation"${s}>)</span>
    --depth, <span class="token parameter variable"${s}>-d</span>      Number of levels deep <span class="token punctuation"${s}>(</span>default: <span class="token number"${s}>5</span><span class="token punctuation"${s}>)</span>
...
app<span class="token punctuation"${s}>.</span><span class="token function"${s}>listen</span><span class="token punctuation"${s}>(</span>port<span class="token punctuation"${s}>)</span></code></pre>`),t(p(o,null,null,u,s));else return[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},'// when using default Vue Router "hash" mode'),n(`
...
app`),a("span",{class:"token punctuation"},"."),a("span",{class:"token function"},"listen"),a("span",{class:"token punctuation"},"("),n("port"),a("span",{class:"token punctuation"},")")])]),a(o)]}),_:1},d,e)),i(p(c(k),null,{default:r((m,t,u,s)=>{if(t)t(`<pre class="doc-code"${s}><code${s}><span class="token comment"${s}>// when using Vue Router &quot;history&quot; mode</span>
<span class="token keyword"${s}>const</span>
  express <span class="token operator"${s}>=</span> <span class="token function"${s}>require</span><span class="token punctuation"${s}>(</span><span class="token string"${s}>&#39;express&#39;</span><span class="token punctuation"${s}>)</span><span class="token punctuation"${s}>,</span>
  serveStatic <span class="token operator"${s}>=</span> <span class="token function"${s}>require</span><span class="token punctuation"${s}>(</span><span class="token string"${s}>&#39;serve-static&#39;</span><span class="token punctuation"${s}>)</span><span class="token punctuation"${s}>,</span>
...
app<span class="token punctuation"${s}>.</span><span class="token function"${s}>use</span><span class="token punctuation"${s}>(</span><span class="token function"${s}>serveStatic</span><span class="token punctuation"${s}>(</span><span class="token operator"${s}>...</span>path<span class="token operator"${s}>-</span>to<span class="token operator"${s}>-</span>dist<span class="token operator"${s}>...</span><span class="token punctuation"${s}>)</span><span class="token punctuation"${s}>)</span>
app<span class="token punctuation"${s}>.</span><span class="token function"${s}>listen</span><span class="token punctuation"${s}>(</span>port<span class="token punctuation"${s}>)</span></code></pre>`),t(p(o,null,null,u,s));else return[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},'// when using Vue Router "history" mode'),n(`
`),a("span",{class:"token keyword"},"const"),n(`
  express `),a("span",{class:"token operator"},"="),n(),a("span",{class:"token function"},"require"),a("span",{class:"token punctuation"},"("),a("span",{class:"token string"},"'express'"),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},","),n(`
  serveStatic `),a("span",{class:"token operator"},"="),n(),a("span",{class:"token function"},"require"),a("span",{class:"token punctuation"},"("),a("span",{class:"token string"},"'serve-static'"),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},","),n(`
...
`),a("span",{class:"token comment"},"// then app.listen(...)")])]),a(o)]}),_:1},d,e)),i(`<p${e}>Finally, run one of these files:</p>`),i(p(c(k),null,{default:r((m,t,u,s)=>{if(t)t(`<pre class="doc-code"${s}><code${s}>$ <span class="token function"${s}>node</span> my-server.js</code></pre>`),t(p(o,{lang:"bash"},null,u,s));else return[a("pre",{class:"doc-code"},[a("code",null,[n("$ "),a("span",{class:"token function"},"node"),n(" my-server.js")])]),a(o,{lang:"bash"})]}),_:1},d,e)),i(`<h2 id="create" class="doc-heading doc-h2"${e}>Create `),i(p(v,{align:"top",color:"brand-primary",label:"legacy"},null,d,e)),i(`</h2><h3 id="scaffolding-a-quasar-project-folder" class="doc-heading doc-h3"${e}>Scaffolding a Quasar project folder</h3><p${e}><code class="doc-token"${e}>quasar create</code> is a legacy command and is not recommended for use except for custom starter kits. You should use <code class="doc-token"${e}>create-quasar</code> instead:</p>`),i(p(c(k),{tabs:["Yarn","NPM","PNPM","Bun"]},{default:r((m,t,u,s)=>{if(t)t(p(b,{class:"q-pa-none",name:"Yarn"},{default:r((g,$,f,l)=>{if($)$(`<pre class="doc-code"${l}><code${l}><span class="token function"${l}>yarn</span> create quasar</code></pre>`),$(p(o,{lang:"bash"},null,f,l));else return[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"yarn"),n(" create quasar")])]),a(o,{lang:"bash"})]}),_:1},u,s)),t(p(b,{class:"q-pa-none",name:"NPM"},{default:r((g,$,f,l)=>{if($)$(`<pre class="doc-code"${l}><code${l}><span class="token function"${l}>npm</span> init quasar</code></pre>`),$(p(o,{lang:"bash"},null,f,l));else return[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"npm"),n(" init quasar")])]),a(o,{lang:"bash"})]}),_:1},u,s)),t(p(b,{class:"q-pa-none",name:"PNPM"},{default:r((g,$,f,l)=>{if($)$(`<pre class="doc-code"${l}><code${l}><span class="token function"${l}>pnpm</span> create quasar</code></pre>`),$(p(o,{lang:"bash"},null,f,l));else return[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"pnpm"),n(" create quasar")])]),a(o,{lang:"bash"})]}),_:1},u,s)),t(p(b,{class:"q-pa-none",name:"Bun"},{default:r((g,$,f,l)=>{if($)$(`<pre class="doc-code"${l}><code${l}>bun create quasar</code></pre>`),$(p(o,{lang:"bash"},null,f,l));else return[a("pre",{class:"doc-code"},[a("code",null,"bun create quasar")]),a(o,{lang:"bash"})]}),_:1},u,s));else return[a(b,{class:"q-pa-none",name:"Yarn"},{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"yarn"),n(" create quasar")])]),a(o,{lang:"bash"})]),_:1}),a(b,{class:"q-pa-none",name:"NPM"},{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"npm"),n(" init quasar")])]),a(o,{lang:"bash"})]),_:1}),a(b,{class:"q-pa-none",name:"PNPM"},{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"pnpm"),n(" create quasar")])]),a(o,{lang:"bash"})]),_:1}),a(b,{class:"q-pa-none",name:"Bun"},{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,"bun create quasar")]),a(o,{lang:"bash"})]),_:1})]}),_:1},d,e)),i(`<h3 id="scaffolding-from-a-custom-starter-kit" class="doc-heading doc-h3"${e}>Scaffolding from a custom starter kit `),i(p(v,{align:"top",color:"brand-primary",label:"legacy"},null,d,e)),i(`</h3><p${e}>Should you wish to create a Quasar project (app, AppExtension or UI kit) from <strong${e}>CUSTOM</strong> starter kits, please use the <code class="doc-token"${e}>@quasar/legacy-create</code> global installable CLI instead:</p>`),i(p(c(k),{tabs:["Yarn","NPM","PNPM","Bun"]},{default:r((m,t,u,s)=>{if(t)t(p(b,{class:"q-pa-none",name:"Yarn"},{default:r((g,$,f,l)=>{if($)$(`<pre class="doc-code"${l}><code${l}><span class="token comment"${l}># globally install the @quasar/legacy-create CLI</span>
...
$ quasar-legacy-create `),a("span",{class:"token operator"},"<"),n("folder_name"),a("span",{class:"token operator"},">"),n(),a("span",{class:"token operator"},"<"),n("address"),a("span",{class:"token operator"},">"),n(),a("span",{class:"token punctuation"},"["),n("--branch "),a("span",{class:"token operator"},"<"),n("branch_name"),a("span",{class:"token operator"},">"),a("span",{class:"token punctuation"},"]")])]),a(o,{lang:"bash"})]}),_:1},u,s)),t(p(b,{class:"q-pa-none",name:"NPM"},{default:r((g,$,f,l)=>{if($)$(`<pre class="doc-code"${l}><code${l}><span class="token comment"${l}># globally install the @quasar/legacy-create CLI</span>
...
`),a("span",{class:"token comment"},"# then:"),n(`
$ quasar-legacy-create `),a("span",{class:"token operator"},"<"),n("folder_name"),a("span",{class:"token operator"},">"),n(),a("span",{class:"token operator"},"<"),n("address"),a("span",{class:"token operator"},">"),n(),a("span",{class:"token punctuation"},"["),n("--branch "),a("span",{class:"token operator"},"<"),n("branch_name"),a("span",{class:"token operator"},">"),a("span",{class:"token punctuation"},"]")])]),a(o,{lang:"bash"})]}),_:1},u,s)),t(p(b,{class:"q-pa-none",name:"PNPM"},{default:r((g,$,f,l)=>{if($)$(`<pre class="doc-code"${l}><code${l}><span class="token comment"${l}># globally install the @quasar/legacy-create CLI</span>
...
`),a("span",{class:"token comment"},"# then:"),n(`
$ quasar-legacy-create `),a("span",{class:"token operator"},"<"),n("folder_name"),a("span",{class:"token operator"},">"),n(),a("span",{class:"token operator"},"<"),n("address"),a("span",{class:"token operator"},">"),n(),a("span",{class:"token punctuation"},"["),n("--branch "),a("span",{class:"token operator"},"<"),n("branch_name"),a("span",{class:"token operator"},">"),a("span",{class:"token punctuation"},"]")])]),a(o,{lang:"bash"})]}),_:1},u,s)),t(p(b,{class:"q-pa-none",name:"Bun"},{default:r((g,$,f,l)=>{if($)$(`<pre class="doc-code"${l}><code${l}><span class="token comment"${l}># globally install the @quasar/legacy-create CLI</span>
<span class="token comment"${l}># experimental support</span>
...
`),a("span",{class:"token comment"},"# when on Windows and using Powershell:"),n(`
$ quasar dev `),a("span",{class:"token parameter variable"},"-m"),n(" ios "),a("span",{class:"token string"},"'--'"),n(" some params "),a("span",{class:"token parameter variable"},"--and"),n(" options "),a("span",{class:"token parameter variable"},"--here"),n(`
$ quasar dev `),a("span",{class:"token parameter variable"},"-m"),n(" electron "),a("span",{class:"token string"},"'--'"),n(" --no-sandbox --disable-setuid-sandbox")])]),a(o,{lang:"bash"})]),_:1}),a("p",null,"If you wish to change the hostname or port serving your App you have 3 options:"),a("ul",null,[a("li",null,[n("Edit the "),a("code",{class:"doc-token"},"/quasar.config"),n(" file:"),a(c(k),null,{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token literal-property property"},"devServer"),a("span",{class:"token operator"},":"),n(),a("span",{class:"token punctuation"},"{"),n(`
  `),a("span",{class:"token literal-property property"},"host"),a("span",{class:"token operator"},":"),n(),a("span",{class:"token string"},"'...'"),a("span",{class:"token punctuation"},","),n(`
  `),a("span",{class:"token literal-property property"},"port"),a("span",{class:"token operator"},":"),n(),a("span",{class:"token operator"},"..."),n(`
...
$ quasar build `),a("span",{class:"token parameter variable"},"-d"),n(),a("span",{class:"token punctuation"},"["),n("-m "),a("span",{class:"token operator"},"<"),n("mode"),a("span",{class:"token operator"},">"),a("span",{class:"token punctuation"},"]")])]),a(o,{lang:"bash"})]),_:1}),a("h2",{id:"clean",class:"doc-heading doc-h2",onClick:m=>c(h)("clean")},"Clean",8,["onClick"]),a("p",null,"Cleans up all the build assets:"),a(c(k),null,{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,"$ quasar clean")]),a(o,{lang:"bash"})]),_:1}),a("h2",{id:"new",class:"doc-heading doc-h2",onClick:m=>c(h)("new")},"New",8,["onClick"]),a("p",null,"Generates Components, Pages, Layouts, Vuex Store."),a("div",{class:"doc-note doc-note--tip"},[a("p",{class:"doc-note__title"},"TIP"),a("p",null,"This command is simply a helper in order to quickly scaffold a page/layout/component/vuex store module. You are not required to use it, but can help you when you don’t know how to start.")]),a(c(k),null,{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[n("$ quasar new "),a("span",{class:"token parameter variable"},"-h"),n(`
 ...
 Methods
   ...
   *No methods*`)])]),a(o,{lang:"bash"})]),_:1}),a("h2",{id:"inspect",class:"doc-heading doc-h2",onClick:m=>c(h)("inspect")},"Inspect",8,["onClick"]),a("p",null,"This command can be used to inspect the Webpack config generated by Quasar CLI."),a(c(k),null,{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[n("$ quasar inspect "),a("span",{class:"token parameter variable"},"-h"),n(`
...
app`),a("span",{class:"token punctuation"},"."),a("span",{class:"token function"},"use"),a("span",{class:"token punctuation"},"("),a("span",{class:"token function"},"serveStatic"),a("span",{class:"token punctuation"},"("),a("span",{class:"token operator"},"..."),n("path"),a("span",{class:"token operator"},"-"),n("to"),a("span",{class:"token operator"},"-"),n("dist"),a("span",{class:"token operator"},"..."),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},")"),n(`
app`),a("span",{class:"token punctuation"},"."),a("span",{class:"token function"},"listen"),a("span",{class:"token punctuation"},"("),n("port"),a("span",{class:"token punctuation"},")")])]),a(o)]),_:1}),a(c(k),null,{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},'// when using Vue Router "history" mode'),n(`
`),a("span",{class:"token keyword"},"const"),n(`
  express `),a("span",{class:"token operator"},"="),n(),a("span",{class:"token function"},"require"),a("span",{class:"token punctuation"},"("),a("span",{class:"token string"},"'express'"),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},","),n(`
  serveStatic `),a("span",{class:"token operator"},"="),n(),a("span",{class:"token function"},"require"),a("span",{class:"token punctuation"},"("),a("span",{class:"token string"},"'serve-static'"),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},","),n(`
  history `),a("span",{class:"token operator"},"="),n(),a("span",{class:"token function"},"require"),a("span",{class:"token punctuation"},"("),a("span",{class:"token string"},"'connect-history-api-fallback'"),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},","),n(`
...
`),a("span",{class:"token comment"},"// then app.listen(...)")])]),a(o)]),_:1}),a("p",null,"Finally, run one of these files:"),a(c(k),null,{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[n("$ "),a("span",{class:"token function"},"node"),n(" my-server.js")])]),a(o,{lang:"bash"})]),_:1}),a("h2",{id:"create",class:"doc-heading doc-h2",onClick:m=>c(h)("create")},[n("Create "),a(v,{align:"top",color:"brand-primary",label:"legacy"})],8,["onClick"]),a("h3",{id:"scaffolding-a-quasar-project-folder",class:"doc-heading doc-h3",onClick:m=>c(h)("scaffolding-a-quasar-project-folder")},"Scaffolding a Quasar project folder",8,["onClick"]),a("p",null,[a("code",{class:"doc-token"},"quasar create"),n(" is a legacy command and is not recommended for use except for custom starter kits. You should use "),a("code",{class:"doc-token"},"create-quasar"),n(" instead:")]),a(c(k),{tabs:["Yarn","NPM","PNPM","Bun"]},{default:r(()=>[a(b,{class:"q-pa-none",name:"Yarn"},{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"yarn"),n(" create quasar")])]),a(o,{lang:"bash"})]),_:1}),a(b,{class:"q-pa-none",name:"NPM"},{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"npm"),n(" init quasar")])]),a(o,{lang:"bash"})]),_:1}),a(b,{class:"q-pa-none",name:"PNPM"},{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"pnpm"),n(" create quasar")])]),a(o,{lang:"bash"})]),_:1}),a(b,{class:"q-pa-none",name:"Bun"},{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,"bun create quasar")]),a(o,{lang:"bash"})]),_:1})]),_:1}),a("h3",{id:"scaffolding-from-a-custom-starter-kit",class:"doc-heading doc-h3",onClick:m=>c(h)("scaffolding-from-a-custom-starter-kit")},[n("Scaffolding from a custom starter kit "),a(v,{align:"top",color:"brand-primary",label:"legacy"})],8,["onClick"]),a("p",null,[n("Should you wish to create a Quasar project (app, AppExtension or UI kit) from "),a("strong",null,"CUSTOM"),n(" starter kits, please use the "),a("code",{class:"doc-token"},"@quasar/legacy-create"),n(" global installable CLI instead:")]),a(c(k),{tabs:["Yarn","NPM","PNPM","Bun"]},{default:r(()=>[a(b,{class:"q-pa-none",name:"Yarn"},{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},"# globally install the @quasar/legacy-create CLI"),n(`
$ `),a("span",{class:"token function"},"yarn"),n(" global "),a("span",{class:"token function"},"add"),n(` @quasar/legacy-create
