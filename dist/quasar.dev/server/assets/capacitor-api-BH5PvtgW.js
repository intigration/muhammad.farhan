...
`),n("span",{class:"token keyword"},"export"),a(),n("span",{class:"token keyword"},"default"),a(),n("span",{class:"token punctuation"},"{"),a(`
  ...
  `),n("span",{class:"token punctuation"},"}"),a(`
`),n("span",{class:"token punctuation"},"}"),a(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("script")]),n("span",{class:"token punctuation"},">")])])]),n(c)]),_:1})]}),_:1},C))}}},v=y.setup;y.setup=(h,f)=>{const w=A();return(w.modules||(w.modules=new Set)).add("src/pages/quasar-cli-vite/developing-capacitor-apps/capacitor-api.md"),v?v(h,f):void 0};const L=S(y,[["__file","capacitor-api.md"]]);export{L as default};
