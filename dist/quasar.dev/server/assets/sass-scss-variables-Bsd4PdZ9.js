import{resolveComponent as V,mergeProps as Q,withCtx as r,unref as s,createVNode as a,useSSRContext as N,createTextVNode as e}from"vue";import{ssrRenderComponent as o}from"vue/server-renderer";import{c as k}from"./page-utils-C-QWsEHe.js";import{D}from"./DocPage-DKr-0pQn.js";import{D as f}from"./DocPrerender-DPOnWPFO.js";import{C as u}from"./CopyButton-l3ndfN49.js";import{D as y}from"./DocCode-BVg0tuSc.js";import{_ as A}from"../server-entry.js";import"quasar";import"@quasar/extras/mdi-v6";import"prismjs";import"vue-router";import"@quasar/extras/fontawesome-v5";import"@quasar/extras/fontawesome-v6";import"@quasar/extras/mdi-v7";import"quasar/icon-set/svg-mdi-v6.mjs";const S=`$space-base   : 16px !default
...
`,g={__name:"SassVariables",__ssrInlineRender:!0,setup(x){return($,d,m,h)=>{const v=V("q-card");d(o(v,Q({flat:"",bordered:""},h),{default:r((L,l,c,t)=>{if(l)l(o(y,{lang:"markup",code:s(S)},null,c,t));else return[a(y,{lang:"markup",code:s(S)},null,8,["code"])]}),_:1},m))}}},C=g.setup;g.setup=(x,$)=>{const d=N();return(d.modules||(d.modules=new Set)).add("src/pages/style/sass-scss-variables/SassVariables.vue"),C?C(x,$):void 0};const q=A(g,[["__file","SassVariables.vue"]]),w={__name:"sass-scss-variables",__ssrInlineRender:!0,setup(x){const $=[{id:"usage",title:"2. Usage"},{id:"caveat",title:"3. Caveat"},{id:"customizing",title:"4. Customizing"},{id:"quasars-css",title:"5. Quasar’s CSS"},{id:"variables-list",title:"6. Variables list"}];return(d,m,h,v)=>{m(o(D,Q({title:"Sass/SCSS Variables",desc:"How to use the Sass/SCSS variables defined by Quasar.",heading:"","edit-link":"style/sass-scss-variables/sass-scss-variables",toc:$},v),{default:r((L,l,c,t)=>{if(l)l(`<p${t}>There are Sass/SCSS variables built into Quasar that you can change and/or use within devland should you wish to.</p><div class="doc-note doc-note--warning"${t}><p class="doc-note__title"${t}>WARNING</p><p${t}>This applies to Quasar CLI managed apps only.</p></div><h2 id="usage" class="doc-heading doc-h2"${t}>Usage</h2><p${t}>In your app’s <code class="doc-token"${t}>*.vue</code> files or in the .sass/.scss files you can use any Quasar Sass/SCSS variables (examples: <code class="doc-token"${t}>$primary</code>, <code class="doc-token"${t}>$red-1</code>), and any other Sass/SCSS variables that you declared in your <code class="doc-token"${t}>/src/css/quasar.variables.sass</code> or the perfectly equivalent <code class="doc-token"${t}>/src/css/quasar.variables.scss</code> (depending on your favorite Sass flavour) when using Quasar CLI.</p>`),l(o(s(f),null,{default:r((i,p,b,n)=>{if(p)p(`<pre class="doc-code"${n}><code${n}><span class="token comment"${n}>&lt;!-- Notice lang=&quot;sass&quot; --&gt;</span>
<span class="token tag"${n}><span class="token tag"${n}><span class="token punctuation"${n}>&lt;</span>style</span> <span class="token attr-name"${n}>lang</span><span class="token attr-value"${n}><span class="token punctuation attr-equals"${n}>=</span><span class="token punctuation"${n}>&quot;</span>sass<span class="token punctuation"${n}>&quot;</span></span><span class="token punctuation"${n}>&gt;</span></span><span class="token style"${n}><span class="token language-css"${n}>
div
  <span class="token property"${n}>color</span><span class="token punctuation"${n}>:</span> $red-1
  <span class="token property"${n}>background-color</span><span class="token punctuation"${n}>:</span> $grey-5
</span></span><span class="token tag"${n}><span class="token tag"${n}><span class="token punctuation"${n}>&lt;/</span>style</span><span class="token punctuation"${n}>&gt;</span></span>

<span class="token comment"${n}>&lt;!-- Notice lang=&quot;scss&quot; --&gt;</span>
<span class="token tag"${n}><span class="token tag"${n}><span class="token punctuation"${n}>&lt;</span>style</span> <span class="token attr-name"${n}>lang</span><span class="token attr-value"${n}><span class="token punctuation attr-equals"${n}>=</span><span class="token punctuation"${n}>&quot;</span>scss<span class="token punctuation"${n}>&quot;</span></span><span class="token punctuation"${n}>&gt;</span></span><span class="token style"${n}><span class="token language-css"${n}>
<span class="token selector"${n}>div</span> <span class="token punctuation"${n}>{</span>
  <span class="token property"${n}>color</span><span class="token punctuation"${n}>:</span> $red-1<span class="token punctuation"${n}>;</span>
  <span class="token property"${n}>background-color</span><span class="token punctuation"${n}>:</span> $grey-5<span class="token punctuation"${n}>;</span>
<span class="token punctuation"${n}>}</span>
</span></span><span class="token tag"${n}><span class="token tag"${n}><span class="token punctuation"${n}>&lt;/</span>style</span><span class="token punctuation"${n}>&gt;</span></span></code></pre>`),p(o(u,null,null,b,n));else return[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},'<!-- Notice lang="sass" -->'),e(`
`),a("span",{class:"token tag"},[a("span",{class:"token tag"},[a("span",{class:"token punctuation"},"<"),e("style")]),e(),a("span",{class:"token attr-name"},"lang"),a("span",{class:"token attr-value"},[a("span",{class:"token punctuation attr-equals"},"="),a("span",{class:"token punctuation"},'"'),e("sass"),a("span",{class:"token punctuation"},'"')]),a("span",{class:"token punctuation"},">")]),a("span",{class:"token style"},[a("span",{class:"token language-css"},[e(`
div
  `),a("span",{class:"token property"},"color"),a("span",{class:"token punctuation"},":"),e(` $red-1
  `),a("span",{class:"token property"},"background-color"),a("span",{class:"token punctuation"},":"),e(` $grey-5
`)])]),a("span",{class:"token tag"},[a("span",{class:"token tag"},[a("span",{class:"token punctuation"},"</"),e("style")]),a("span",{class:"token punctuation"},">")]),e(`

`),a("span",{class:"token comment"},'<!-- Notice lang="scss" -->'),e(`
`),a("span",{class:"token tag"},[a("span",{class:"token tag"},[a("span",{class:"token punctuation"},"<"),e("style")]),e(),a("span",{class:"token attr-name"},"lang"),a("span",{class:"token attr-value"},[a("span",{class:"token punctuation attr-equals"},"="),a("span",{class:"token punctuation"},'"'),e("scss"),a("span",{class:"token punctuation"},'"')]),a("span",{class:"token punctuation"},">")]),a("span",{class:"token style"},[a("span",{class:"token language-css"},[e(`
`),a("span",{class:"token selector"},"div"),e(),a("span",{class:"token punctuation"},"{"),e(`
  `),a("span",{class:"token property"},"color"),a("span",{class:"token punctuation"},":"),e(" $red-1"),a("span",{class:"token punctuation"},";"),e(`
  `),a("span",{class:"token property"},"background-color"),a("span",{class:"token punctuation"},":"),e(" $grey-5"),a("span",{class:"token punctuation"},";"),e(`
`),a("span",{class:"token punctuation"},"}"),e(`
`)])]),a("span",{class:"token tag"},[a("span",{class:"token tag"},[a("span",{class:"token punctuation"},"</"),e("style")]),a("span",{class:"token punctuation"},">")])])]),a(u)]}),_:1},c,t)),l(`<div class="doc-note doc-note--tip"${t}><p class="doc-note__title"${t}>TIP</p><p${t}>You don’t need to necessarily have the <code class="doc-token"${t}>src/css/quasar.variables.sass</code> or <code class="doc-token"${t}>src/css/quasar.variables.scss</code> files if you want to access the Quasar Sass/SCSS variables. Create one of them only if you want to customize the variables.</p></div><div class="doc-note doc-note--danger"${t}><p class="doc-note__title"${t}>WARNING</p><p${t}>When creating or deleting any of the <code class="doc-token"${t}>src/css/quasar.variables.*</code> files, you will need to restart your dev server in order for it to take effect. However, when you change the content of these files it won’t be necessary to also restart.</p></div><h2 id="caveat" class="doc-heading doc-h2"${t}>Caveat</h2><p${t}>Quasar CLI detects if the file contains at least one ‘$’ character, and if so, it automatically imports the Quasar Sass/SCSS variables.</p><p${t}>If, however, you have a nested importing statement and the file from which you are importing does not contain any ‘$’ characters, this won’t work. In this case, you need to add a simple comment (<code class="doc-token"${t}>// $</code>) so Quasar can detect at least one ‘$’ character:</p>`),l(o(s(f),null,{default:r((i,p,b,n)=>{if(p)p(`<pre class="doc-code"${n}><code${n}><span class="token tag"${n}><span class="token tag"${n}><span class="token punctuation"${n}>&lt;</span>style</span> <span class="token attr-name"${n}>lang</span><span class="token attr-value"${n}><span class="token punctuation attr-equals"${n}>=</span><span class="token punctuation"${n}>&quot;</span>sass<span class="token punctuation"${n}>&quot;</span></span><span class="token punctuation"${n}>&gt;</span></span><span class="token style"${n}><span class="token language-css"${n}>
// $

@import <span class="token string"${n}>&#39;some-file.sass&#39;</span>
// now some-file.sass can benefit
// from Quasar Sass variables too
// due to comment above
</span></span><span class="token tag"${n}><span class="token tag"${n}><span class="token punctuation"${n}>&lt;/</span>style</span><span class="token punctuation"${n}>&gt;</span></span></code></pre>`),p(o(u,null,null,b,n));else return[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token tag"},[a("span",{class:"token tag"},[a("span",{class:"token punctuation"},"<"),e("style")]),e(),a("span",{class:"token attr-name"},"lang"),a("span",{class:"token attr-value"},[a("span",{class:"token punctuation attr-equals"},"="),a("span",{class:"token punctuation"},'"'),e("sass"),a("span",{class:"token punctuation"},'"')]),a("span",{class:"token punctuation"},">")]),a("span",{class:"token style"},[a("span",{class:"token language-css"},[e(`
// $

@import `),a("span",{class:"token string"},"'some-file.sass'"),e(`
// now some-file.sass can benefit
// from Quasar Sass variables too
// due to comment above
`)])]),a("span",{class:"token tag"},[a("span",{class:"token tag"},[a("span",{class:"token punctuation"},"</"),e("style")]),a("span",{class:"token punctuation"},">")])])]),a(u)]}),_:1},c,t)),l(`<p${t}>Same is required for .sass/.scss files that are included from quasar.config file &gt; css.</p><h2 id="customizing" class="doc-heading doc-h2"${t}>Customizing</h2><p${t}>If you want to customize the variables (or add your own) and your project does not yet have a <code class="doc-token"${t}>src/css/quasar.variables.sass</code> (or <code class="doc-token"${t}>src/css/quasar.variables.scss</code>) file, create one of them yourself. It doesn’t matter if you pick .sass or .scss as the extension for this file. <strong${t}>Having one of them will provide the variables to ALL your .sass AND .scss project files (including inside of .vue files).</strong></p><p${t}>You can freely override any of Quasar’s variables (see next section) in those files. For convenience, if you picked Sass or SCSS when you created your Quasar project folder, these files initially contain only the brand color-related variables.</p><p${t}>If you want more than to override a Quasar Sass variable, but to extend one, you can achieve it in the next way:</p>`),l(o(s(f),null,{default:r((i,p,b,n)=>{if(p)p(`<pre class="doc-code"${n}><code${n}><span class="token keyword"${n}>@use</span> <span class="token string"${n}>&quot;quasar/src/css/variables&quot;</span> <span class="token module-modifier keyword"${n}>as</span> q<span class="token punctuation"${n}>;</span>
<span class="token keyword"${n}>@use</span> <span class="token string"${n}>&quot;sass:map&quot;</span><span class="token punctuation"${n}>;</span>

<span class="token property"${n}><span class="token variable"${n}>$space-xxl</span></span><span class="token punctuation"${n}>:</span> <span class="token punctuation"${n}>(</span><span class="token property"${n}>x</span><span class="token punctuation"${n}>:</span> 64px<span class="token punctuation"${n}>,</span> <span class="token property"${n}>y</span><span class="token punctuation"${n}>:</span> 64px<span class="token punctuation"${n}>)</span><span class="token punctuation"${n}>;</span>

<span class="token property"${n}><span class="token variable"${n}>$new-spaces</span></span><span class="token punctuation"${n}>:</span> <span class="token punctuation"${n}>(</span>
  <span class="token property"${n}>xxl</span><span class="token punctuation"${n}>:</span> <span class="token variable"${n}>$space-xxl</span><span class="token punctuation"${n}>,</span>
<span class="token punctuation"${n}>)</span><span class="token punctuation"${n}>;</span>

<span class="token property"${n}><span class="token variable"${n}>$spaces</span></span><span class="token punctuation"${n}>:</span> map.<span class="token function"${n}>merge</span><span class="token punctuation"${n}>(</span>q.<span class="token variable"${n}>$spaces</span><span class="token punctuation"${n}>,</span> <span class="token variable"${n}>$new-spaces</span><span class="token punctuation"${n}>)</span><span class="token punctuation"${n}>;</span></code></pre>`),p(o(u,null,null,b,n));else return[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token keyword"},"@use"),e(),a("span",{class:"token string"},'"quasar/src/css/variables"'),e(),a("span",{class:"token module-modifier keyword"},"as"),e(" q"),a("span",{class:"token punctuation"},";"),e(`
`),a("span",{class:"token keyword"},"@use"),e(),a("span",{class:"token string"},'"sass:map"'),a("span",{class:"token punctuation"},";"),e(`

`),a("span",{class:"token property"},[a("span",{class:"token variable"},"$space-xxl")]),a("span",{class:"token punctuation"},":"),e(),a("span",{class:"token punctuation"},"("),a("span",{class:"token property"},"x"),a("span",{class:"token punctuation"},":"),e(" 64px"),a("span",{class:"token punctuation"},","),e(),a("span",{class:"token property"},"y"),a("span",{class:"token punctuation"},":"),e(" 64px"),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},";"),e(`

`),a("span",{class:"token property"},[a("span",{class:"token variable"},"$new-spaces")]),a("span",{class:"token punctuation"},":"),e(),a("span",{class:"token punctuation"},"("),e(`
  `),a("span",{class:"token property"},"xxl"),a("span",{class:"token punctuation"},":"),e(),a("span",{class:"token variable"},"$space-xxl"),a("span",{class:"token punctuation"},","),e(`
`),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},";"),e(`

`),a("span",{class:"token property"},[a("span",{class:"token variable"},"$spaces")]),a("span",{class:"token punctuation"},":"),e(" map."),a("span",{class:"token function"},"merge"),a("span",{class:"token punctuation"},"("),e("q."),a("span",{class:"token variable"},"$spaces"),a("span",{class:"token punctuation"},","),e(),a("span",{class:"token variable"},"$new-spaces"),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},";")])]),a(u)]}),_:1},c,t)),l(`<div class="doc-note doc-note--tip"${t}><p class="doc-note__title"${t}>TIP</p><p${t}>Quasar is very easy to customize without the need of tampering with the Sass/SCSS variables, so make sure that you really need to do that. Not having one of the two files will actually speed up your build while the default variables will still be supplied to .sass/.scss/.vue files.</p></div><h2 id="quasars-css" class="doc-heading doc-h2"${t}>Quasar’s CSS</h2><p${t}>Quasar’s own CSS is compiled using the variables file (if it exists), but there are multiple forms (sass, scss). So there has to be a priority list for Quasar CLI:</p><ul${t}><li${t}>Does <code class="doc-token"${t}>src/css/quasar.variables.scss</code> exists? Use that.</li><li${t}>If not, then does <code class="doc-token"${t}>src/css/quasar.variables.sass</code> exists? Use that.</li><li${t}>If not, then use pre-compiled Quasar CSS.</li></ul><h2 id="variables-list" class="doc-heading doc-h2"${t}>Variables list</h2>`),l(o(q,null,null,c,t));else return[a("p",null,"There are Sass/SCSS variables built into Quasar that you can change and/or use within devland should you wish to."),a("div",{class:"doc-note doc-note--warning"},[a("p",{class:"doc-note__title"},"WARNING"),a("p",null,"This applies to Quasar CLI managed apps only.")]),a("h2",{id:"usage",class:"doc-heading doc-h2",onClick:i=>s(k)("usage")},"Usage",8,["onClick"]),a("p",null,[e("In your app’s "),a("code",{class:"doc-token"},"*.vue"),e(" files or in the .sass/.scss files you can use any Quasar Sass/SCSS variables (examples: "),a("code",{class:"doc-token"},"$primary"),e(", "),a("code",{class:"doc-token"},"$red-1"),e("), and any other Sass/SCSS variables that you declared in your "),a("code",{class:"doc-token"},"/src/css/quasar.variables.sass"),e(" or the perfectly equivalent "),a("code",{class:"doc-token"},"/src/css/quasar.variables.scss"),e(" (depending on your favorite Sass flavour) when using Quasar CLI.")]),a(s(f),null,{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},'<!-- Notice lang="sass" -->'),e(`
`),a("span",{class:"token tag"},[a("span",{class:"token tag"},[a("span",{class:"token punctuation"},"<"),e("style")]),e(),a("span",{class:"token attr-name"},"lang"),a("span",{class:"token attr-value"},[a("span",{class:"token punctuation attr-equals"},"="),a("span",{class:"token punctuation"},'"'),e("sass"),a("span",{class:"token punctuation"},'"')]),a("span",{class:"token punctuation"},">")]),a("span",{class:"token style"},[a("span",{class:"token language-css"},[e(`
div
  `),a("span",{class:"token property"},"color"),a("span",{class:"token punctuation"},":"),e(` $red-1
  `),a("span",{class:"token property"},"background-color"),a("span",{class:"token punctuation"},":"),e(` $grey-5
...
`),a("span",{class:"token selector"},"div"),e(),a("span",{class:"token punctuation"},"{"),e(`
  ...
  `),a("span",{class:"token property"},"background-color"),a("span",{class:"token punctuation"},":"),e(" $grey-5"),a("span",{class:"token punctuation"},";"),e(`
`),a("span",{class:"token punctuation"},"}"),e(`
`)])]),a("span",{class:"token tag"},[a("span",{class:"token tag"},[a("span",{class:"token punctuation"},"</"),e("style")]),a("span",{class:"token punctuation"},">")])])]),a(u)]),_:1}),a("div",{class:"doc-note doc-note--tip"},[a("p",{class:"doc-note__title"},"TIP"),a("p",null,[e("You don’t need to necessarily have the "),a("code",{class:"doc-token"},"src/css/quasar.variables.sass"),e(" or "),a("code",{class:"doc-token"},"src/css/quasar.variables.scss"),e(" files if you want to access the Quasar Sass/SCSS variables. Create one of them only if you want to customize the variables.")])]),a("div",{class:"doc-note doc-note--danger"},[a("p",{class:"doc-note__title"},"WARNING"),a("p",null,[e("When creating or deleting any of the "),a("code",{class:"doc-token"},"src/css/quasar.variables.*"),e(" files, you will need to restart your dev server in order for it to take effect. However, when you change the content of these files it won’t be necessary to also restart.")])]),a("h2",{id:"caveat",class:"doc-heading doc-h2",onClick:i=>s(k)("caveat")},"Caveat",8,["onClick"]),a("p",null,"Quasar CLI detects if the file contains at least one ‘$’ character, and if so, it automatically imports the Quasar Sass/SCSS variables."),a("p",null,[e("If, however, you have a nested importing statement and the file from which you are importing does not contain any ‘$’ characters, this won’t work. In this case, you need to add a simple comment ("),a("code",{class:"doc-token"},"// $"),e(") so Quasar can detect at least one ‘$’ character:")]),a(s(f),null,{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token tag"},[a("span",{class:"token tag"},[a("span",{class:"token punctuation"},"<"),e("style")]),e(),a("span",{class:"token attr-name"},"lang"),a("span",{class:"token attr-value"},[a("span",{class:"token punctuation attr-equals"},"="),a("span",{class:"token punctuation"},'"'),e("sass"),a("span",{class:"token punctuation"},'"')]),a("span",{class:"token punctuation"},">")]),a("span",{class:"token style"},[a("span",{class:"token language-css"},[e(`
// $
...
// from Quasar Sass variables too
// due to comment above
`)])]),a("span",{class:"token tag"},[a("span",{class:"token tag"},[a("span",{class:"token punctuation"},"</"),e("style")]),a("span",{class:"token punctuation"},">")])])]),a(u)]),_:1}),a("p",null,"Same is required for .sass/.scss files that are included from quasar.config file > css."),a("h2",{id:"customizing",class:"doc-heading doc-h2",onClick:i=>s(k)("customizing")},"Customizing",8,["onClick"]),a("p",null,[e("If you want to customize the variables (or add your own) and your project does not yet have a "),a("code",{class:"doc-token"},"src/css/quasar.variables.sass"),e(" (or "),a("code",{class:"doc-token"},"src/css/quasar.variables.scss"),e(") file, create one of them yourself. It doesn’t matter if you pick .sass or .scss as the extension for this file. "),a("strong",null,"Having one of them will provide the variables to ALL your .sass AND .scss project files (including inside of .vue files).")]),a("p",null,"You can freely override any of Quasar’s variables (see next section) in those files. For convenience, if you picked Sass or SCSS when you created your Quasar project folder, these files initially contain only the brand color-related variables."),a("p",null,"If you want more than to override a Quasar Sass variable, but to extend one, you can achieve it in the next way:"),a(s(f),null,{default:r(()=>[a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token keyword"},"@use"),e(),a("span",{class:"token string"},'"quasar/src/css/variables"'),e(),a("span",{class:"token module-modifier keyword"},"as"),e(" q"),a("span",{class:"token punctuation"},";"),e(`
`),a("span",{class:"token keyword"},"@use"),e(),a("span",{class:"token string"},'"sass:map"'),a("span",{class:"token punctuation"},";"),e(`
...
`),a("span",{class:"token property"},[a("span",{class:"token variable"},"$spaces")]),a("span",{class:"token punctuation"},":"),e(" map."),a("span",{class:"token function"},"merge"),a("span",{class:"token punctuation"},"("),e("q."),a("span",{class:"token variable"},"$spaces"),a("span",{class:"token punctuation"},","),e(),a("span",{class:"token variable"},"$new-spaces"),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},";")])]),a(u)]),_:1}),a("div",{class:"doc-note doc-note--tip"},[a("p",{class:"doc-note__title"},"TIP"),a("p",null,"Quasar is very easy to customize without the need of tampering with the Sass/SCSS variables, so make sure that you really need to do that. Not having one of the two files will actually speed up your build while the default variables will still be supplied to .sass/.scss/.vue files.")]),a("h2",{id:"quasars-css",class:"doc-heading doc-h2",onClick:i=>s(k)("quasars-css")},"Quasar’s CSS",8,["onClick"]),a("p",null,"Quasar’s own CSS is compiled using the variables file (if it exists), but there are multiple forms (sass, scss). So there has to be a priority list for Quasar CLI:"),a("ul",null,[a("li",null,[e("Does "),a("code",{class:"doc-token"},"src/css/quasar.variables.scss"),e(" exists? Use that.")]),a("li",null,[e("If not, then does "),a("code",{class:"doc-token"},"src/css/quasar.variables.sass"),e(" exists? Use that.")]),a("li",null,"If not, then use pre-compiled Quasar CSS.")]),a("h2",{id:"variables-list",class:"doc-heading doc-h2",onClick:i=>s(k)("variables-list")},"Variables list",8,["onClick"]),a(q)]}),_:1},h))}}},z=w.setup;w.setup=(x,$)=>{const d=N();return(d.modules||(d.modules=new Set)).add("src/pages/style/sass-scss-variables/sass-scss-variables.md"),z?z(x,$):void 0};const X=A(w,[["__file","sass-scss-variables.md"]]);export{X as default};
