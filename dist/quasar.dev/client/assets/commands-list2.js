...
`),a("span",{class:"token comment"},"# when on Windows and using Powershell:"),n(`
$ quasar dev `),a("span",{class:"token parameter variable"},"-m"),n(" ios "),a("span",{class:"token string"},"'--'"),n(" some params "),a("span",{class:"token parameter variable"},"--and"),n(" options "),a("span",{class:"token parameter variable"},"--here"),n(`
$ quasar dev `),a("span",{class:"token parameter variable"},"-m"),n(" electron "),a("span",{class:"token string"},"'--'"),n(" --no-sandbox --disable-setuid-sandbox")])],-1),E=a("p",null,"If you wish to change the hostname or port serving your App you have 3 options:",-1),N=a("code",{class:"doc-token"},"/quasar.config",-1),O=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token literal-property property"},"devServer"),a("span",{class:"token operator"},":"),n(),a("span",{class:"token punctuation"},"{"),n(`
...
`),a("span",{class:"token punctuation"},"}")])],-1),B=a("li",null,"Through ‘-H’ (hostname) and ‘-p’ (port) command options.",-1),j=a("pre",{class:"doc-code"},[a("code",null,[n("$ "),a("span",{class:"token assign-left variable"},"PORT"),a("span",{class:"token operator"},"="),a("span",{class:"token number"},"3000"),n(` quasar dev
$ `),a("span",{class:"token assign-left variable"},[a("span",{class:"token environment constant"},"HOSTNAME")]),a("span",{class:"token operator"},"="),a("span",{class:"token number"},"1.1"),n(".1.14 quasar dev")])],-1),M=a("p",null,"If there appears to be an issue with hot reload, you can try two fixes:",-1),R=a("p",null,"Change the permissions for the project folder with",-1),L=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"sudo"),n(),a("span",{class:"token function"},"chown"),n(),a("span",{class:"token parameter variable"},"-R"),n(" username: "),a("span",{class:"token builtin class-name"},".")])],-1),U=a("p",null,"or run the dev server with root privileges",-1),W=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"sudo"),n(" quasar dev")])],-1),H=a("pre",{class:"doc-code"},[a("code",null,[n("$ quasar build "),a("span",{class:"token parameter variable"},"-h"),n(`
  ...
  Options
    ...
    --publish, `),a("span",{class:"token parameter variable"},"-P"),n("  Publish options "),a("span",{class:"token punctuation"},"["),n("onTag"),a("span",{class:"token operator"},"|"),n("onTagOrDraft"),a("span",{class:"token operator"},"|"),n("always"),a("span",{class:"token operator"},"|"),n("never"),a("span",{class:"token punctuation"},"]"),n(`
                     - see https://www.electron.build/configuration/publish`)])],-1),V=a("p",null,"The Quasar CLI can pack everything together and optimize your App for production. It minifies source code, extracts vendor components, leverages browser cache and much more.",-1),Y=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},"# Build a SPA for production"),n(`
$ quasar build
`),a("span",{class:"token comment"},"# ...or"),n(`
...
$ quasar build `),a("span",{class:"token parameter variable"},"-d"),n(),a("span",{class:"token punctuation"},"["),n("-m "),a("span",{class:"token operator"},"<"),n("mode"),a("span",{class:"token operator"},">"),a("span",{class:"token punctuation"},"]")])],-1),X=a("p",null,"Cleans up all the build assets:",-1),z=a("pre",{class:"doc-code"},[a("code",null,"$ quasar clean")],-1),F=a("p",null,"Generates Components, Pages, Layouts, Vuex Store.",-1),G=a("div",{class:"doc-note doc-note--tip"},[a("p",{class:"doc-note__title"},"TIP"),a("p",null,"This command is simply a helper in order to quickly scaffold a page/layout/component/vuex store module. You are not required to use it, but can help you when you don’t know how to start.")],-1),J=a("pre",{class:"doc-code"},[a("code",null,[n("$ quasar new "),a("span",{class:"token parameter variable"},"-h"),n(`
  ...
  Options
    ...
    `),a("span",{class:"token parameter variable"},"--format"),n(),a("span",{class:"token parameter variable"},"-f"),n(),a("span",{class:"token operator"},"<"),n("option"),a("span",{class:"token operator"},">"),n("  "),a("span",{class:"token punctuation"},"("),n("optional"),a("span",{class:"token punctuation"},")"),n(" Use a supported "),a("span",{class:"token function"},"format"),n(),a("span",{class:"token keyword"},"for"),n(` the template
                          Possible values:
                             ...
                             * ts - Plain TS template `),a("span",{class:"token punctuation"},"("),n("for boot, store, and ssrmiddleware files"),a("span",{class:"token punctuation"},")")])],-1),K=a("pre",{class:"doc-code"},[a("code",null,[n("$ quasar mode "),a("span",{class:"token parameter variable"},"-h"),n(`
  ...
  Options
    ...
    --help, `),a("span",{class:"token parameter variable"},"-h"),n("            Displays this message")])],-1),pa=a("pre",{class:"doc-code"},[a("code",null,[n(`$ quasar describe QIcon
 ...
 Methods
   ...
   *No methods*`)])],-1),ca=a("p",null,"This command can be used to inspect the Webpack config generated by Quasar CLI.",-1),ia=a("pre",{class:"doc-code"},[a("code",null,[n("$ quasar inspect "),a("span",{class:"token parameter variable"},"-h"),n(`
  ...
  Usage
    ...
    $ quasar inspect `),a("span",{class:"token parameter variable"},"-m"),n(" electron "),a("span",{class:"token parameter variable"},"-p"),n(),a("span",{class:"token string"},"'module.rules'"),n(`
  ...
  Options
    ...
    --mode, `),a("span",{class:"token parameter variable"},"-m"),n("       App mode "),a("span",{class:"token punctuation"},"["),n("spa"),a("span",{class:"token operator"},"|"),n("ssr"),a("span",{class:"token operator"},"|"),n("pwa"),a("span",{class:"token operator"},"|"),n("bex"),a("span",{class:"token operator"},"|"),n("cordova"),a("span",{class:"token operator"},"|"),n("electron"),a("span",{class:"token punctuation"},"]"),n(),a("span",{class:"token punctuation"},"("),n("default: spa"),a("span",{class:"token punctuation"},")"),n(`
    --depth, `),a("span",{class:"token parameter variable"},"-d"),n("      Number of levels deep "),a("span",{class:"token punctuation"},"("),n("default: "),a("span",{class:"token number"},"5"),a("span",{class:"token punctuation"},")"),n(`
    ...
    --help, `),a("span",{class:"token parameter variable"},"-h"),n("       Displays this message")])],-1),ua=a("pre",{class:"doc-code"},[a("code",null,[n("$ quasar ext "),a("span",{class:"token parameter variable"},"-h"),n(`
  ...
  Options
    --help, `),a("span",{class:"token parameter variable"},"-h"),n("       Displays this message")])],-1),da=a("pre",{class:"doc-code"},[a("code",null,[n("$ quasar run "),a("span",{class:"token parameter variable"},"-h"),n(`
  ...
  Options
    --help, `),a("span",{class:"token parameter variable"},"-h"),n("       Displays this message")])],-1),ka=a("p",null,[n("This command can be used in production too and it is being supplied by the global installation of "),a("code",{class:"doc-token"},"@quasar/cli"),n(" package.")],-1),ma=a("pre",{class:"doc-code"},[a("code",null,[n("$ quasar serve "),a("span",{class:"token parameter variable"},"-h"),n(`
  ...
  Proxy `),a("span",{class:"token function"},"file"),n(` example
    `),a("span",{class:"token builtin class-name"},"export"),n(" default "),a("span",{class:"token punctuation"},"["),n(`
      ...
      `),a("span",{class:"token punctuation"},"}"),n(`
    `),a("span",{class:"token punctuation"},"]"),n(`
    --`),a("span",{class:"token operator"},">"),n(" will be transformed into app.use"),a("span",{class:"token punctuation"},"("),n("path, httpProxyMiddleware"),a("span",{class:"token punctuation"},"("),n("rule"),a("span",{class:"token punctuation"},"))")])],-1),ha=a("p",null,"When building a SPA or PWA, the distributable folder can be served by any static webserver. To test it out (assuming you don’t have a specific publicPath or not using Vue Router “history” mode), you can use the “http-server” npm package.",-1),ba=a("p",null,"Or you can build your own server. Here are some examples:",-1),fa=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},'// when using default Vue Router "hash" mode'),n(`
`),a("span",{class:"token keyword"},"const"),n(`
...
app`),a("span",{class:"token punctuation"},"."),a("span",{class:"token function"},"listen"),a("span",{class:"token punctuation"},"("),n("port"),a("span",{class:"token punctuation"},")")])],-1),va=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},'// when using Vue Router "history" mode'),n(`
`),a("span",{class:"token keyword"},"const"),n(`
  express `),a("span",{class:"token operator"},"="),n(),a("span",{class:"token function"},"require"),a("span",{class:"token punctuation"},"("),a("span",{class:"token string"},"'express'"),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},","),n(`
  serveStatic `),a("span",{class:"token operator"},"="),n(),a("span",{class:"token function"},"require"),a("span",{class:"token punctuation"},"("),a("span",{class:"token string"},"'serve-static'"),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},","),n(`
...
app`),a("span",{class:"token punctuation"},"."),a("span",{class:"token function"},"use"),a("span",{class:"token punctuation"},"("),a("span",{class:"token function"},"serveStatic"),a("span",{class:"token punctuation"},"("),a("span",{class:"token operator"},"..."),n("path"),a("span",{class:"token operator"},"-"),n("to"),a("span",{class:"token operator"},"-"),n("dist"),a("span",{class:"token operator"},"..."),a("span",{class:"token punctuation"},")"),a("span",{class:"token punctuation"},")"),n(`
app`),a("span",{class:"token punctuation"},"."),a("span",{class:"token function"},"listen"),a("span",{class:"token punctuation"},"("),n("port"),a("span",{class:"token punctuation"},")")])],-1),ga=a("p",null,"If you need URL rewrites of API, or simply put you want to proxy your API requests, then you can use “http-proxy-middleware” package:",-1),ya=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},"// add this to one of the two previous examples:"),n(`
...
`),a("span",{class:"token comment"},"// then app.listen(...)")])],-1),wa=a("p",null,"Finally, run one of these files:",-1),_a=a("pre",{class:"doc-code"},[a("code",null,[n("$ "),a("span",{class:"token function"},"node"),n(" my-server.js")])],-1),qa=a("p",null,[a("code",{class:"doc-token"},"quasar create"),n(" is a legacy command and is not recommended for use except for custom starter kits. You should use "),a("code",{class:"doc-token"},"create-quasar"),n(" instead:")],-1),$a=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"yarn"),n(" create quasar")])],-1),xa=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"npm"),n(" init quasar")])],-1),Ca=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token function"},"pnpm"),n(" create quasar")])],-1),Pa=a("pre",{class:"doc-code"},[a("code",null,"bun create quasar")],-1),Aa=a("p",null,[n("Should you wish to create a Quasar project (app, AppExtension or UI kit) from "),a("strong",null,"CUSTOM"),n(" starter kits, please use the "),a("code",{class:"doc-token"},"@quasar/legacy-create"),n(" global installable CLI instead:")],-1),Ia=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},"# globally install the @quasar/legacy-create CLI"),n(`
...
`),a("span",{class:"token comment"},"# then:"),n(`
$ quasar-legacy-create `),a("span",{class:"token operator"},"<"),n("folder_name"),a("span",{class:"token operator"},">"),n(),a("span",{class:"token operator"},"<"),n("address"),a("span",{class:"token operator"},">"),n(),a("span",{class:"token punctuation"},"["),n("--branch "),a("span",{class:"token operator"},"<"),n("branch_name"),a("span",{class:"token operator"},">"),a("span",{class:"token punctuation"},"]")])],-1),Qa=a("pre",{class:"doc-code"},[a("code",null,[a("span",{class:"token comment"},"# globally install the @quasar/legacy-create CLI"),n(`
`),a("span",{class:"token comment"},"# experimental support"),n(`
$ bun `),a("span",{class:"token function"},"install"),n(),a("span",{class:"token parameter variable"},"-g"),n(` @quasar/legacy-create

`),a("span",{class:"token comment"},"# then:"),n(`
$ quasar-legacy-create `),a("span",{class:"token operator"},"<"),n("folder_name"),a("span",{class:"token operator"},">"),n(),a("span",{class:"token operator"},"<"),n("address"),a("span",{class:"token operator"},">"),n(),a("span",{class:"token punctuation"},"["),n("--branch "),a("span",{class:"token operator"},"<"),n("branch_name"),a("span",{class:"token operator"},">"),a("span",{class:"token punctuation"},"]")])],-1),Ta=a("p",null,[n("With a starter kit stored on your machine by providing a "),a("strong",null,"local path"),n(" to a folder: "),a("code",{class:"doc-token"},"quasar-legacy-create <folder> ./my-custom-starter-kit"),n(".")],-1),Ea=a("p",null,"With a starter kit stored into any publicly accessible Git repository by providing a reference which follows this schema:",-1),Na=a("ul",null,[a("li",null,[n("GitHub - "),a("code",{class:"doc-token"},"github:owner/name"),n(" or simply "),a("code",{class:"doc-token"},"owner/name")]),a("li",null,[n("GitLab - "),a("code",{class:"doc-token"},"gitlab:owner/name")]),a("li",null,[n("Bitbucket - "),a("code",{class:"doc-token"},"bitbucket:owner/name")])],-1),Oa=a("p",null,[a("code",{class:"doc-token"},"master"),n(" branch will be checked out by default, but you can specify the one you prefer via "),a("code",{class:"doc-token"},"--branch <branch name>"),n(" (eg. "),a("code",{class:"doc-token"},"quasar-legacy-create <folder> owner/name --branch my-branch"),n(").")],-1),Ba=a("div",{class:"doc-note doc-note--warning"},[a("p",{class:"doc-note__title"},"WARNING"),a("p",null,"The preferred way to build reusable code and UI Components into Quasar ecosystem are App Extensions. Use a custom starter kit only if you really know what you’re doing and be aware that it will make more difficult for the Quasar team to provide you assistance.")],-1),ja={__name:"commands-list",setup(Ma){const k=[{id:"upgrade",title:"2. Upgrade"},{id:"info",title:"3. Info"},{id:"dev",title:"4. Dev"},{id:"build",title:"5. Build"},{id:"clean",title:"6. Clean"},{id:"new",title:"7. New"},{id:"mode",title:"8. Mode"},{id:"describe",title:"9. Describe"},{id:"inspect",title:"10. Inspect"},{id:"ext",title:"11. Ext"},{id:"run",title:"12. Run"},{id:"serve",title:"13. Serve"},{id:"custom-node-server",title:"13.1. Custom Node server",sub:!0},{id:"create",title:"14. Create"},{id:"scaffolding-a-quasar-project-folder",title:"14.1. Scaffolding a Quasar project folder",sub:!0},{id:"scaffolding-from-a-custom-starter-kit",title:"14.2. Scaffolding from a custom starter kit",sub:!0}];return(Ra,r)=>(m(),h(f,{title:"Commands List",desc:"(@quasar/app-webpack) The entire list of Quasar CLI commands.",overline:"Quasar CLI with Webpack - @quasar/app-webpack",heading:"","edit-link":"quasar-cli-webpack/commands-list",toc:k},{default:o(()=>[g,s(e(l),null,{default:o(()=>[y,s(t,{lang:"bash"})]),_:1}),w,s(e(l),null,{default:o(()=>[_,s(t,{lang:"bash"})]),_:1}),a("h2",{id:"upgrade",class:"doc-heading doc-h2",onClick:r[0]||(r[0]=c=>e(p)("upgrade"))},"Upgrade"),q,s(e(l),null,{default:o(()=>[$,s(t,{lang:"bash"})]),_:1}),x,a("h2",{id:"info",class:"doc-heading doc-h2",onClick:r[1]||(r[1]=c=>e(p)("info"))},"Info"),C,P,s(e(l),null,{default:o(()=>[A,s(t,{lang:"bash"})]),_:1}),a("h2",{id:"dev",class:"doc-heading doc-h2",onClick:r[2]||(r[2]=c=>e(p)("dev"))},"Dev"),s(e(l),null,{default:o(()=>[I,s(t,{lang:"bash"})]),_:1}),S,D,Q,s(e(l),null,{default:o(()=>[T,s(t,{lang:"bash"})]),_:1}),E,a("ul",null,[a("li",null,[n("Edit the "),N,n(" file:"),s(e(l),null,{default:o(()=>[O,s(t)]),_:1})]),B,a("li",null,[n("If this is a one time thing, specify the hostname and/or port as an environment variable:"),s(e(l),null,{default:o(()=>[j,s(t,{lang:"bash"})]),_:1})])]),M,a("ul",null,[a("li",null,[R,s(e(l),null,{default:o(()=>[L,s(t,{lang:"bash"})]),_:1})]),a("li",null,[U,s(e(l),null,{default:o(()=>[W,s(t,{lang:"bash"})]),_:1})])]),a("h2",{id:"build",class:"doc-heading doc-h2",onClick:r[3]||(r[3]=c=>e(p)("build"))},"Build"),s(e(l),null,{default:o(()=>[H,s(t,{lang:"bash"})]),_:1}),V,s(e(l),null,{default:o(()=>[Y,s(t,{lang:"bash"})]),_:1}),a("h2",{id:"clean",class:"doc-heading doc-h2",onClick:r[4]||(r[4]=c=>e(p)("clean"))},"Clean"),X,s(e(l),null,{default:o(()=>[z,s(t,{lang:"bash"})]),_:1}),a("h2",{id:"new",class:"doc-heading doc-h2",onClick:r[5]||(r[5]=c=>e(p)("new"))},"New"),F,G,s(e(l),null,{default:o(()=>[J,s(t,{lang:"bash"})]),_:1}),a("h2",{id:"mode",class:"doc-heading doc-h2",onClick:r[6]||(r[6]=c=>e(p)("mode"))},"Mode"),s(e(l),null,{default:o(()=>[K,s(t,{lang:"bash"})]),_:1}),Z,aa,s(b,{class:"doc-page-table","wrap-cells":!0,flat:!0,bordered:!0},{default:o(()=>[na,sa]),_:1}),ea,s(e(l),null,{default:o(()=>[oa,s(t,{lang:"bash"})]),_:1}),a("h2",{id:"describe",class:"doc-heading doc-h2",onClick:r[7]||(r[7]=c=>e(p)("describe"))},"Describe"),ta,ra,s(e(l),null,{default:o(()=>[la,s(t,{lang:"bash"})]),_:1}),s(e(l),null,{default:o(()=>[pa,s(t,{lang:"bash"})]),_:1}),a("h2",{id:"inspect",class:"doc-heading doc-h2",onClick:r[8]||(r[8]=c=>e(p)("inspect"))},"Inspect"),ca,s(e(l),null,{default:o(()=>[ia,s(t,{lang:"bash"})]),_:1}),a("h2",{id:"ext",class:"doc-heading doc-h2",onClick:r[9]||(r[9]=c=>e(p)("ext"))},"Ext"),a("p",null,[n("This command is used to manage "),s(d,{to:"/app-extensions/introduction"},{default:o(()=>[n("App Extensions")]),_:1}),n(".")]),s(e(l),null,{default:o(()=>[ua,s(t,{lang:"bash"})]),_:1}),a("h2",{id:"run",class:"doc-heading doc-h2",onClick:r[10]||(r[10]=c=>e(p)("run"))},"Run"),a("p",null,[n("This command is used to run commands supplied by the "),s(d,{to:"/app-extensions/introduction"},{default:o(()=>[n("App Extensions")]),_:1}),n(" that you’ve installed into your project folder.")]),s(e(l),null,{default:o(()=>[da,s(t,{lang:"bash"})]),_:1}),a("h2",{id:"serve",class:"doc-heading doc-h2",onClick:r[11]||(r[11]=c=>e(p)("serve"))},"Serve"),ka,s(e(l),null,{default:o(()=>[ma,s(t,{lang:"bash"})]),_:1}),a("h3",{id:"custom-node-server",class:"doc-heading doc-h3",onClick:r[12]||(r[12]=c=>e(p)("custom-node-server"))},"Custom Node server"),ha,ba,s(e(l),null,{default:o(()=>[fa,s(t)]),_:1}),s(e(l),null,{default:o(()=>[va,s(t)]),_:1}),ga,s(e(l),null,{default:o(()=>[ya,s(t)]),_:1}),wa,s(e(l),null,{default:o(()=>[_a,s(t,{lang:"bash"})]),_:1}),a("h2",{id:"create",class:"doc-heading doc-h2",onClick:r[13]||(r[13]=c=>e(p)("create"))},[n("Create "),s(u,{align:"top",color:"brand-primary",label:"legacy"})]),a("h3",{id:"scaffolding-a-quasar-project-folder",class:"doc-heading doc-h3",onClick:r[14]||(r[14]=c=>e(p)("scaffolding-a-quasar-project-folder"))},"Scaffolding a Quasar project folder"),qa,s(e(l),{tabs:["Yarn","NPM","PNPM","Bun"]},{default:o(()=>[s(i,{class:"q-pa-none",name:"Yarn"},{default:o(()=>[$a,s(t,{lang:"bash"})]),_:1}),s(i,{class:"q-pa-none",name:"NPM"},{default:o(()=>[xa,s(t,{lang:"bash"})]),_:1}),s(i,{class:"q-pa-none",name:"PNPM"},{default:o(()=>[Ca,s(t,{lang:"bash"})]),_:1}),s(i,{class:"q-pa-none",name:"Bun"},{default:o(()=>[Pa,s(t,{lang:"bash"})]),_:1})]),_:1}),a("h3",{id:"scaffolding-from-a-custom-starter-kit",class:"doc-heading doc-h3",onClick:r[15]||(r[15]=c=>e(p)("scaffolding-from-a-custom-starter-kit"))},[n("Scaffolding from a custom starter kit "),s(u,{align:"top",color:"brand-primary",label:"legacy"})]),Aa,s(e(l),{tabs:["Yarn","NPM","PNPM","Bun"]},{default:o(()=>[s(i,{class:"q-pa-none",name:"Yarn"},{default:o(()=>[Ia,s(t,{lang:"bash"})]),_:1}),s(i,{class:"q-pa-none",name:"NPM"},{default:o(()=>[Sa,s(t,{lang:"bash"})]),_:1}),s(i,{class:"q-pa-none",name:"PNPM"},{default:o(()=>[Da,s(t,{lang:"bash"})]),_:1}),s(i,{class:"q-pa-none",name:"Bun"},{default:o(()=>[Qa,s(t,{lang:"bash"})]),_:1})]),_:1}),Ta,Ea,Na,Oa,Ba]),_:1}))}},Xa=v(ja,[["__file","commands-list.md"]]);export{Xa as default};
