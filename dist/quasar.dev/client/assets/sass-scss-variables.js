import{c as p}from"./_examples_frameless-electron-window.js";import{D as c}from"./DocPage.js";import{D as s}from"./DocPrerender.js";import{C as u}from"./CopyButton.js";import{b as i,d as $,w as d,e as l,f as t,z as m,h as e,i as a}from"./vendor.js";import{D as h}from"./DocCode.js";import{_ as x}from"./index.js";const k=`$space-base   : 16px !default
...
`,v={__name:"SassVariables",setup(f){return(r,b)=>(i(),$(m,{flat:"",bordered:""},{default:d(()=>[l(h,{lang:"markup",code:t(k)},null,8,["code"])]),_:1}))}},g=x(v,[["__file","SassVariables.vue"]]),w=e("p",null,"There are Sass/SCSS variables built into Quasar that you can change and/or use within devland should you wish to.",-1),y=e("div",{class:"doc-note doc-note--warning"},[e("p",{class:"doc-note__title"},"WARNING"),e("p",null,"This applies to Quasar CLI managed apps only.")],-1),_=e("p",null,[a("In your app’s "),e("code",{class:"doc-token"},"*.vue"),a(" files or in the .sass/.scss files you can use any Quasar Sass/SCSS variables (examples: "),e("code",{class:"doc-token"},"$primary"),a(", "),e("code",{class:"doc-token"},"$red-1"),a("), and any other Sass/SCSS variables that you declared in your "),e("code",{class:"doc-token"},"/src/css/quasar.variables.sass"),a(" or the perfectly equivalent "),e("code",{class:"doc-token"},"/src/css/quasar.variables.scss"),a(" (depending on your favorite Sass flavour) when using Quasar CLI.")],-1),z=e("pre",{class:"doc-code"},[e("code",null,[e("span",{class:"token comment"},'<!-- Notice lang="sass" -->'),a(`
`),e("span",{class:"token tag"},[e("span",{class:"token tag"},[e("span",{class:"token punctuation"},"<"),a("style")]),a(),e("span",{class:"token attr-name"},"lang"),e("span",{class:"token attr-value"},[e("span",{class:"token punctuation attr-equals"},"="),e("span",{class:"token punctuation"},'"'),a("sass"),e("span",{class:"token punctuation"},'"')]),e("span",{class:"token punctuation"},">")]),e("span",{class:"token style"},[e("span",{class:"token language-css"},[a(`
div
  `),e("span",{class:"token property"},"color"),e("span",{class:"token punctuation"},":"),a(` $red-1
  `),e("span",{class:"token property"},"background-color"),e("span",{class:"token punctuation"},":"),a(` $grey-5
`)])]),e("span",{class:"token tag"},[e("span",{class:"token tag"},[e("span",{class:"token punctuation"},"</"),a("style")]),e("span",{class:"token punctuation"},">")]),a(`

`),e("span",{class:"token comment"},'<!-- Notice lang="scss" -->'),a(`
`),e("span",{class:"token tag"},[e("span",{class:"token tag"},[e("span",{class:"token punctuation"},"<"),a("style")]),a(),e("span",{class:"token attr-name"},"lang"),e("span",{class:"token attr-value"},[e("span",{class:"token punctuation attr-equals"},"="),e("span",{class:"token punctuation"},'"'),a("scss"),e("span",{class:"token punctuation"},'"')]),e("span",{class:"token punctuation"},">")]),e("span",{class:"token style"},[e("span",{class:"token language-css"},[a(`
`),e("span",{class:"token selector"},"div"),a(),e("span",{class:"token punctuation"},"{"),a(`
  `),e("span",{class:"token property"},"color"),e("span",{class:"token punctuation"},":"),a(" $red-1"),e("span",{class:"token punctuation"},";"),a(`
  `),e("span",{class:"token property"},"background-color"),e("span",{class:"token punctuation"},":"),a(" $grey-5"),e("span",{class:"token punctuation"},";"),a(`
`),e("span",{class:"token punctuation"},"}"),a(`
`)])]),e("span",{class:"token tag"},[e("span",{class:"token tag"},[e("span",{class:"token punctuation"},"</"),a("style")]),e("span",{class:"token punctuation"},">")])])],-1),S=e("div",{class:"doc-note doc-note--tip"},[e("p",{class:"doc-note__title"},"TIP"),e("p",null,[a("You don’t need to necessarily have the "),e("code",{class:"doc-token"},"src/css/quasar.variables.sass"),a(" or "),e("code",{class:"doc-token"},"src/css/quasar.variables.scss"),a(" files if you want to access the Quasar Sass/SCSS variables. Create one of them only if you want to customize the variables.")])],-1),C=e("div",{class:"doc-note doc-note--danger"},[e("p",{class:"doc-note__title"},"WARNING"),e("p",null,[a("When creating or deleting any of the "),e("code",{class:"doc-token"},"src/css/quasar.variables.*"),a(" files, you will need to restart your dev server in order for it to take effect. However, when you change the content of these files it won’t be necessary to also restart.")])],-1),q=e("p",null,"Quasar CLI detects if the file contains at least one ‘$’ character, and if so, it automatically imports the Quasar Sass/SCSS variables.",-1),Q=e("p",null,[a("If, however, you have a nested importing statement and the file from which you are importing does not contain any ‘$’ characters, this won’t work. In this case, you need to add a simple comment ("),e("code",{class:"doc-token"},"// $"),a(") so Quasar can detect at least one ‘$’ character:")],-1),I=e("pre",{class:"doc-code"},[e("code",null,[e("span",{class:"token tag"},[e("span",{class:"token tag"},[e("span",{class:"token punctuation"},"<"),a("style")]),a(),e("span",{class:"token attr-name"},"lang"),e("span",{class:"token attr-value"},[e("span",{class:"token punctuation attr-equals"},"="),e("span",{class:"token punctuation"},'"'),a("sass"),e("span",{class:"token punctuation"},'"')]),e("span",{class:"token punctuation"},">")]),e("span",{class:"token style"},[e("span",{class:"token language-css"},[a(`
// $

@import `),e("span",{class:"token string"},"'some-file.sass'"),a(`
// now some-file.sass can benefit
// from Quasar Sass variables too
// due to comment above
`)])]),e("span",{class:"token tag"},[e("span",{class:"token tag"},[e("span",{class:"token punctuation"},"</"),a("style")]),e("span",{class:"token punctuation"},">")])])],-1),N=e("p",null,"Same is required for .sass/.scss files that are included from quasar.config file > css.",-1),V=e("p",null,[a("If you want to customize the variables (or add your own) and your project does not yet have a "),e("code",{class:"doc-token"},"src/css/quasar.variables.sass"),a(" (or "),e("code",{class:"doc-token"},"src/css/quasar.variables.scss"),a(") file, create one of them yourself. It doesn’t matter if you pick .sass or .scss as the extension for this file. "),e("strong",null,"Having one of them will provide the variables to ALL your .sass AND .scss project files (including inside of .vue files).")],-1),D=e("p",null,"You can freely override any of Quasar’s variables (see next section) in those files. For convenience, if you picked Sass or SCSS when you created your Quasar project folder, these files initially contain only the brand color-related variables.",-1),A=e("p",null,"If you want more than to override a Quasar Sass variable, but to extend one, you can achieve it in the next way:",-1),B=e("pre",{class:"doc-code"},[e("code",null,[e("span",{class:"token keyword"},"@use"),a(),e("span",{class:"token string"},'"quasar/src/css/variables"'),a(),e("span",{class:"token module-modifier keyword"},"as"),a(" q"),e("span",{class:"token punctuation"},";"),a(`
`),e("span",{class:"token keyword"},"@use"),a(),e("span",{class:"token string"},'"sass:map"'),e("span",{class:"token punctuation"},";"),a(`

`),e("span",{class:"token property"},[e("span",{class:"token variable"},"$space-xxl")]),e("span",{class:"token punctuation"},":"),a(),e("span",{class:"token punctuation"},"("),e("span",{class:"token property"},"x"),e("span",{class:"token punctuation"},":"),a(" 64px"),e("span",{class:"token punctuation"},","),a(),e("span",{class:"token property"},"y"),e("span",{class:"token punctuation"},":"),a(" 64px"),e("span",{class:"token punctuation"},")"),e("span",{class:"token punctuation"},";"),a(`

`),e("span",{class:"token property"},[e("span",{class:"token variable"},"$new-spaces")]),e("span",{class:"token punctuation"},":"),a(),e("span",{class:"token punctuation"},"("),a(`
  `),e("span",{class:"token property"},"xxl"),e("span",{class:"token punctuation"},":"),a(),e("span",{class:"token variable"},"$space-xxl"),e("span",{class:"token punctuation"},","),a(`
`),e("span",{class:"token punctuation"},")"),e("span",{class:"token punctuation"},";"),a(`

`),e("span",{class:"token property"},[e("span",{class:"token variable"},"$spaces")]),e("span",{class:"token punctuation"},":"),a(" map."),e("span",{class:"token function"},"merge"),e("span",{class:"token punctuation"},"("),a("q."),e("span",{class:"token variable"},"$spaces"),e("span",{class:"token punctuation"},","),a(),e("span",{class:"token variable"},"$new-spaces"),e("span",{class:"token punctuation"},")"),e("span",{class:"token punctuation"},";")])],-1),H=e("div",{class:"doc-note doc-note--tip"},[e("p",{class:"doc-note__title"},"TIP"),e("p",null,"Quasar is very easy to customize without the need of tampering with the Sass/SCSS variables, so make sure that you really need to do that. Not having one of the two files will actually speed up your build while the default variables will still be supplied to .sass/.scss/.vue files.")],-1),L=e("p",null,"Quasar’s own CSS is compiled using the variables file (if it exists), but there are multiple forms (sass, scss). So there has to be a priority list for Quasar CLI:",-1),T=e("ul",null,[e("li",null,[a("Does "),e("code",{class:"doc-token"},"src/css/quasar.variables.scss"),a(" exists? Use that.")]),e("li",null,[a("If not, then does "),e("code",{class:"doc-token"},"src/css/quasar.variables.sass"),a(" exists? Use that.")]),e("li",null,"If not, then use pre-compiled Quasar CSS.")],-1),P={__name:"sass-scss-variables",setup(f){const r=[{id:"usage",title:"2. Usage"},{id:"caveat",title:"3. Caveat"},{id:"customizing",title:"4. Customizing"},{id:"quasars-css",title:"5. Quasar’s CSS"},{id:"variables-list",title:"6. Variables list"}];return(b,n)=>(i(),$(c,{title:"Sass/SCSS Variables",desc:"How to use the Sass/SCSS variables defined by Quasar.",heading:"","edit-link":"style/sass-scss-variables/sass-scss-variables",toc:r},{default:d(()=>[w,y,e("h2",{id:"usage",class:"doc-heading doc-h2",onClick:n[0]||(n[0]=o=>t(p)("usage"))},"Usage"),_,l(t(s),null,{default:d(()=>[z,l(u)]),_:1}),S,C,e("h2",{id:"caveat",class:"doc-heading doc-h2",onClick:n[1]||(n[1]=o=>t(p)("caveat"))},"Caveat"),q,Q,l(t(s),null,{default:d(()=>[I,l(u)]),_:1}),N,e("h2",{id:"customizing",class:"doc-heading doc-h2",onClick:n[2]||(n[2]=o=>t(p)("customizing"))},"Customizing"),V,D,A,l(t(s),null,{default:d(()=>[B,l(u)]),_:1}),H,e("h2",{id:"quasars-css",class:"doc-heading doc-h2",onClick:n[3]||(n[3]=o=>t(p)("quasars-css"))},"Quasar’s CSS"),L,T,e("h2",{id:"variables-list",class:"doc-heading doc-h2",onClick:n[4]||(n[4]=o=>t(p)("variables-list"))},"Variables list"),l(g)]),_:1}))}},E=x(P,[["__file","sass-scss-variables.md"]]);export{E as default};
