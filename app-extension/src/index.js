...
function extendConf (conf, api) {
  ...
  conf.boot.push('~quasar-app-extension-npm/src/boot/register.js')
  ...
  if (api.hasWebpack) {
    ...
    transpileTarget.push(/quasar-app-extension-npm[\\/]src/)
  }

  // make sure the stylesheet goes through webpack to avoid SSR issues
  conf.css.push('~quasar-ui-npm/src/index.sass')
}
...
export default function (api) {
  ...
  // api.registerDescribeApi('MyComponent', '~quasar-ui-npm/src/components/MyComponent.json')
