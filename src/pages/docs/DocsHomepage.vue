<template>
  <div class="page-docs column justify-center text-center">
    <div class="heading heading--large normal-line-height">Welcome to Genislab Technologies</div>
    <div class="letter-spacing-300 text-size-16 text-weight-bold q-mb-md">
      Here you can find everything you need to start working with Genislab.
    </div>
