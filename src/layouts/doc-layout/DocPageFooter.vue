<template>
  <div class="doc-page-footer doc-brand">
    ...
    <div class="doc-page-footer__copyright text-weight-bold text-center q-pa-lg letter-spacing-100">
      <div>
      <p> Copyright ©2024 Genislab Tech, </p>
        <a
          href="https://github.com/genislab"
          target="_blank"
          class="text-brand-accent text-light"
        >Genislab Technologies and TheMachineBox both are operated and registered as independant business entities.</a>
      </div>
      <div>
        There are no online agents at the moment
        <a
          href="https://www.genislab.com/"
          target="_blank"
