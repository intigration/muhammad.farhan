    ...
    <div class="doc-heading doc-h1" id="introduction" v-if="props.heading">
      ...
      >
        <q-tooltip class="row no-wrap items-center">
          <span>Caught a bug? again you can edit this page in browser</span>
...
useMeta(
  props.desc !== void 0
    ? { title: props.title, meta: getMeta(props.title + ' | Genislab Automations', props.desc) }
    : { title: props.title }
)
