  ...
  <q-layout :view="view">
    ...
    >
      ...
      <q-img class="absolute-top" src="https://cdn.quasar.dev/img/material.png" style="height: 204px">
        <div class="absolute-bottom bg-transparent">
          ...
          <div class="text-weight-bold">Genislab Technologies</div>
          <div>@rstoenescu</div>
        </div>
      </q-img>
    </q-drawer>
    ...
    >
      <q-toolbar>
        ...
        <q-toolbar-title>Genislab</q-toolbar-title>
...
useMeta({
  ...
  meta: getMeta(
    'Layout Builder | Genislab Technologies',
    'Tool to build Agent. Configure the Agent parts then export the code.'
  )
})
